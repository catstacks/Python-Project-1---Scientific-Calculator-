# Credit: https://raw.githubusercontent.com/nikhilgajam/Python-Projects/master/Scientific%20Calculator%20Project/Scientific%20Calculator.py
...
root = Tk()
root.geometry("650x400+300+300") # Used to set the dimensions of the calculator window. 650 width by 400 height. The last two values control the position of the window: 300 shifted on x-axis, 300 shifted on y-axis. 
root.iconbitmap(True, "images/Dtafalonso-Android-Lollipop-Calculator.ico") # Shows icon next to app name when opened 
root.title("Scientific Calculator") # The name displayed in the app window
